...
export function Sidebar({ onOpenSearch, isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "w-64 bg-sidebar border-r border-sidebar-border h-screen flex flex-col fixed left-0 top-0 z-40 transition-transform duration-300 ease-in-out",
          "lg:translate-x-0",
      ...
      >
        ...
        <div className="px-3 pb-2">
          <button
            onClick={() => { onOpenSearch?.(); handleLinkClick(); }}
          ...
          >
            ...
            <span className="hidden sm:flex items-center gap-0.5 text-[10px] border border-border rounded px-1 py-0.5 font-mono opacity-60 group-hover:opacity-100">
